...
export const contractService = {
    ...
    async aiReview(contractId) {
        ...
        // 规则引擎执行
        const ruleResult = await ruleEngineService.executeRules({ amount: contract.amount, type: contract.type }, 'contract');
        const auditResult = {
